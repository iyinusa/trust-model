<?php include(APPPATH.'libraries/inc.php'); ?>
		<div class="container-fluid">
            <div id="filter">
              <h4><i class="fa fa-pencil"></i> Manage Professions</h4>
            </div>
            ...
            <div class="row">
            	<div class="col-lg-12">
                    ...
                    <?php echo form_open('profession/add') ?>
                        <div class="form-group mr5">
                            <input name="profession_id" type="hidden" value="<?php if(!empty($e_id)){echo $e_id;} ?>">
                            <input name="name" type="text" placeholder="Profession Name" class="form-control" value="<?php if(!empty($e_name)){echo $e_name;} ?>" required="required">
                        </div>
                    ...
                    if(!empty($allprofession)){
                        foreach($allprofession as $profession){
                            ...
                            if(strtolower($log_user_role) == 'administrator'){
                                $del_btn = '<a href="'.base_url().'profession/add?del='.$profession->id.'" class="btn btn-danger btn-xs"><i class="fa fa-times"></i> <b>Delete</b></a>';
                            } else {$del_btn = '';}
                            
                            $dir_list .= '
                                <tr>
                                    <td>'.ucwords($profession->name).'</td>
                                    <td align="center">
                                        <a href="'.base_url().'profession/add?edit='.$profession->id.'" class="btn btn-primary btn-xs"><i class="fa fa-pencil"></i> <b>Edit</b></a>
                                        '.$del_btn.'
                                    </td>
                                </tr>
                            ';	
                ...
                <?php if(!empty($rec_del)){ ?>
					<?php if($rec_del!=''){ ?>
                        <?php echo form_open_multipart('profession/delete'); ?>
                ...
                <div class="col-lg-12">
                    <section class="panel panel-default">
                        <header class="panel-heading">
                            <h5><i class="fa fa-briefcase"></i> Professions</h5>
                        </header>
